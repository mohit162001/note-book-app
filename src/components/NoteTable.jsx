                  ...
                  {notes.map((note, index) => (
                    <TableRow key={note.id}>
                      ...
                      <TableCell className="notehistory-actions">
                        ...
                        <button className="notehistory-btn" onClick={() => handleDelete(note.id, note.attributes.title)}>Delete</button>
                        <button className="notehistory-btn" onClick={() => handleModal({ title: note.attributes.title, content: note.attributes.content })}>View</button>
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
